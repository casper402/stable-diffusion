...
def plot(volume_idx, slice_num):
    test_dirs = [
        ...
        os.path.expanduser(f"/Users/Niklas/thesis/predictions/thesis-ready/490/best-model/1000-steps-linear/volume-{volume_idx}"),
        # os.path.expanduser(f"/Users/Niklas/thesis/predictions/thesis-ready/490/best-model/ddim/linear/1-steps/0/volume-{volume_idx}"),
        # os.path.expanduser(f"/Users/Niklas/thesis/predictions/thesis-ready/256/best-model/50-steps-linear/volume-{volume_idx}"),
        # os.path.expanduser(f"/Users/Niklas/thesis/predictions/thesis-ready/128/best-model/50-steps-linear/volume-{volume_idx}"),
        # os.path.expanduser(f"/Users/Niklas/thesis/predictions/thesis-ready/64/best-model/50-steps-linear/volume-{volume_idx}"),
        # os.path.expanduser(f"/Users/Niklas/thesis/predictions/thesis-ready/32/best-model/50-steps-linear/volume-{volume_idx}"),
